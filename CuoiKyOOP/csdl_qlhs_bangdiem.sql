...
CREATE TABLE `bangdiem` (
  ...
  `congNghe` float DEFAULT NULL,
  `tinHoc` float DEFAULT NULL,
  `theDuc` char(1) DEFAULT NULL,
  `ngoaiNgu` float DEFAULT NULL,
  `maNN` char(2) DEFAULT NULL,
  `hocLuc` char(2) DEFAULT NULL,
  `hanhKiem` char(2) DEFAULT NULL,
  `ghiChuDiem` text,
  PRIMARY KEY (`maHS`)
...
-- Dump completed on 2024-09-25 23:48:20
